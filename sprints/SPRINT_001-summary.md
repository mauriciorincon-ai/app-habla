...
| **6. UX/A11y**         | ✅             | axe limpio en las 3 rutas ×2 dispositivos **y dentro del juego** (paleta del niño + modo calma). Touch del niño ≥64 px (verificado por e2e), adulto ≥44 px. `prefers-reduced-motion` + ajuste propio. COGA: sin límite de tiempo, sin game-over, errores sin castigo. Microcopy 100 % es-CO.         |
