...
verdad pasó**. En **gemelas**: altavoz en cada picto del par. **Fallback silencioso siempre**: sin
grabación o con el toggle apagado, la app suena como antes (texto sin voz), nunca un error. El
**cohete y el globo quedan intactos** (ADR-007). Toggle en Ajustes para apagar sin borrar el banco.
...
| ----------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Testing**          | ✅                   | **139 unit** (motores del banco: catálogo/cobertura/lotes/almacén con `fake-indexeddb`; gemelas; barajar; privacidad-banco) + **103 e2e** (estudio con mic falso, voz-familiar, gemelas, cero-red grabar+reproducir, axe ×2 rutas nuevas). Cobertura de motores **90 % stmts / 83 % branches**. Todo en CI.                                                                                                                                                       |
