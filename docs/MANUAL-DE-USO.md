# Hablemos San — Manual de uso

> Para el papá o la mamá que va a usar la app con su hijo. En español llano, sin tecnicismos.

## Qué es esta app

**Hablemos San** responde todos los días a una sola pregunta: _"¿y hoy qué puedo hacer por mi
hijo?"_. Cada día le propone una técnica con respaldo científico, explicada en 30 segundos, con
**una línea concreta que usted puede decirle hoy** y una actividad para hacer juntos. Algunos días
...
1. Abra la app en el navegador de la tablet o el teléfono (Chrome en Android).
2. **Instálela como app** (opcional pero recomendado): en el menú del navegador, "Añadir a la
...
2. **Permiso del micrófono.** El navegador le pregunta si puede escuchar. Debe aceptar para jugar.
...
**¿Y si el niño se aburre o se frustra?**
Se para y ya. No hay castigo, ni racha que se pierda, ni pantalla de derrota. Si el juego le pesa,
pruebe el modo calma, o haga la actividad del día sin pantalla.

**¿Por qué la app no me dice si pronunció bien?**
Porque sería mentira. La tecnología que reconoce voz infantil se equivoca demasiado a esa edad, y
